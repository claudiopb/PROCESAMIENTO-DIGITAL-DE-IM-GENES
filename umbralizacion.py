...
## crea una matriz llena de zeros
font = cv2.FONT_HERSHEY_SIMPLEX
##coloca un texto
cv2.putText(grises,'Umbral: T=130',(100,70),font,1.5,(255),2,cv2.LINE_AA)
##selecciona elementos de la matriz grises
##      eje y  eje x valor que llevara cada elemento 
...
## threshold regresa dos variables la primera (_) no se uso la segunda binaruzada si
_,binarizada=cv2.threshold(grises2,130,255,cv2.THRESH_BINARY)
  # 2da var       funcion   src    umb comb    metodo
